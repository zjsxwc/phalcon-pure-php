...
namespace Phalcon
{
    ...
    class Crypt implements \Phalcon\CryptInterface
    {
         ...
         *
         * @param
         *            return_value Result, possibly padded
         * @param
         *            text Message to be padded
         * @param
         *            mode Encryption mode; padding is applied only in CBC or ECB mode
         * @param
         *            block_size Cipher block size
         * @param
         *            padding_type Padding scheme
         ...
         *
         * @param
         *            return_value Result, possibly unpadded
         * @param
         *            text Message to be unpadded
         * @param
         *            mode Encryption mode; unpadding is applied only in CBC or ECB mode
         * @param
         *            block_size Cipher block size
         * @param
         *            padding_type Padding scheme
