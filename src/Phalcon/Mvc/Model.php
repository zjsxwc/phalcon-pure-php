...
namespace Phalcon\Mvc
{
    ...
    abstract class Model implements \Phalcon\Mvc\ModelInterface, \Phalcon\Mvc\Model\ResultInterface, \Phalcon\Di\InjectionAwareInterface, \Serializable
    {
         ...
         * @param
         *            \Phalcon\Mvc\Model\ManagerInterface modelsManager
         */
         ...
         *
         * @param
         *            \Phalcon\Mvc\ModelInterface|Phalcon\Mvc\Model\Row base
         * @param
         *            array data
         * @param
         *            array columnMap
         ...
         *
         * @param
         *            \Phalcon\Mvc\Model\MessageInterface message
         * @return \Phalcon\Mvc\Model
         */
         ...
         *            \Phalcon\Db\AdapterInterface connection
         * @param
         *            \Phalcon\Mvc\ModelInterface[] related
         * @return boolean
         */
         ...
         * If the instance already exists in the persistance it will throw an exception
         * Returning true on success or false otherwise.
         *
         * <code>
         * //Creating a new robot
         ...
         * If the instance doesn't exist in the persistance it will throw an exception
         * Returning true on success or false otherwise.
         *
         * <code>
         * //Updating a robot name
         ...
         *
         * @param
         *            \Phalcon\Mvc\Model\BehaviorInterface behavior
         */
