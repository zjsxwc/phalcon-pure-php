...
namespace Phalcon\Mvc\Model
{
    ...
    abstract class Resultset implements \Phalcon\Mvc\Model\ResultsetInterface, \Iterator, \Traversable, \SeekableIterator, \Countable, \ArrayAccess, \Serializable
    {
        ...
        /**
         * Resulsets cannot be changed.
         * It has only been implemented to meet the definition of the ArrayAccess interface
         *
         * @param
         *            int index
         * @param
         *            \Phalcon\Mvc\ModelInterface value
         */
