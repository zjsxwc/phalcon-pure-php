...
namespace Phalcon\Mvc\Model\Resultset
{
    ...
    class Simple extends \Phalcon\Mvc\Model\Resultset implements \Serializable, \ArrayAccess, \Countable, \SeekableIterator, \Traversable, \Iterator, \Phalcon\Mvc\Model\ResultsetInterface
    {
         ...
         *            array columnMap
         * @param
         *            \Phalcon\Mvc\ModelInterface|Phalcon\Mvc\Model\Row model
         * @param
         *            \Phalcon\Db\Result\Pdo|null result
         * @param
         *            \Phalcon\Cache\BackendInterface cache
         * @param
         ...
         * Export the resultset to an array
