...
namespace Phalcon\Mvc
{
    ...
    class Router
    {
        ...
        /**
         * Get rewrite info.
         * This info is read from $_GET['_url']. This returns '/' if the rewrite information cannot be read
         *
         * @return string
         */
        ...
        /**
         * Sets the URI source.
         * One of the URI_SOURCE_* constants
         *
         * <code>
         ...
         * If a route is missing a path the router will use the defined here
         ...
         *
         * @param
         *            \Phalcon\Mvc\Router\Group route
         * @return \Phalcon\Mvc\Router
         */
